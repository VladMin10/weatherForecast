...
class ForecastDataService: ObservableObject {
    ...
    func getForecasts(lat: Double, lon: Double) {
        let urlString = "https://api.weatherbit.io/v2.0/forecast/daily?lat=\(lat)&lon=\(lon)&days=16&lang=en&key=b772a64ad1e34d25946efd0a0e999016"
    ...
    func getForecasts(for cityName: String, completion: @escaping (Bool) -> Void) {
        ...
        let urlString = "https://api.weatherbit.io/v2.0/forecast/daily?city=\(encodedCityName)&days=16&lang=en&key=b772a64ad1e34d25946efd0a0e999016"
        print("Request URL: \(urlString)")
